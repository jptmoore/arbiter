...
This will generate an access token for an App called 'foo' that has permissions to be spent by a Store called 'bar' provided the same exact permissions have been previously granted and a secret has also be generated.
